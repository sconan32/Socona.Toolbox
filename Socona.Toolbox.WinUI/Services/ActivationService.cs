using Socona.ToolBox.DesignPatterns;
...
namespace Socona.ToolBox.WinUI.Services
{
    ...
    public class ActivationService
    {
        ...
        {
            return args is Microsoft.UI.Xaml.LaunchActivatedEventArgs;
        }

        public async Task ActivateFromShareTargetAsync(ShareTargetActivatedEventArgs activationArgs)
        {
