using Socona.ToolBox.SwiftMemory.Enumerables;
using Socona.ToolBox.SwiftMemory.Helpers;
using System;
...
using RuntimeHelpers = Socona.ToolBox.SwiftMemory.Helpers.RuntimeHelpers;

namespace Socona.ToolBox.SwiftMemory.Extensions
{
